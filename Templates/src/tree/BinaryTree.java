...
public class BinaryTree<Key extends Comparable<Key>, Value> {
    ...
    public Node delete(Node x, Key key) {
        ...
        if (cmp > 0) {
            ...
            // 4.1 左子树或者右子树为空，意味着不需要去找到右子树中最小的结点了
            // 右子树为空，直接返回左子树
            if (x.right == null) {
                return x.left;
            }
            ...
            // 5.左子树和右子树都不为空，需要找到右子树中最小的结点，并删除
            Node minNode = null;
            Node n = x.right;
            while (n.left != null) {
                // 没有子节点了
            ...
            //6.让x结点的左子树成为minNode的左子树
            minNode.left = x.left;
            //7.让x结点的右子树成为minNode的右子树
            minNode.right = x.right;
            //8.把让x结点替换成minNode，那么x节点原来的父结点就指向了minNode
            x = minNode;
        }
